...
def reset_level(level):
	player.reset(60, screen_height - 70)
	blob_group.empty()
	lava_group.empty()
	exit_group.empty()
...
class Player():
    ...
    def update(self,game_over):
        ...
        if game_over == 0:
            ...
            #check for collusion with enemies
        ...
        for row in data:
            ...
            for tile in row:
                ...
                if tile == 2:
                    ...
                    self.tile_list.append(tile)
                if tile == 3:
                    blob = Enemy(col_count*tile_size+3,row_count*tile_size+12)
                    blob_group.add(blob)
                if tile == 4:
...
player = Player(60,screen_height - 70)
...
restart_button = Button(screen_width//2-60, screen_height//2 - 60,restart_img)
start_button = Button(screen_width//2 - 100, screen_height//2-40,start_img)
exit_button = Button(screen_width//2 + 10, screen_height//2-40,exit_img)

run = True
while run:
    clock.tick(fps)
    screen.blit(sky_img, (0, 0))
    screen.blit(sun_img, (70, 35))
